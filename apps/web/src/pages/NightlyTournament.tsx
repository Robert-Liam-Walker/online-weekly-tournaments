...
// The service centers on a single nightly tournament, so there is no list and
...
export default function NightlyTournament() {
    ...
    return (
      <div className="flex flex-col items-center justify-center gap-2 px-6 py-24 text-center">
        ...
        <p className="text-gray-400 text-sm">
          A new nightly bracket opens every evening — check back soon.
        </p>
